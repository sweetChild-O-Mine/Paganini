<div align="center">
  <img src="client/public/logo.png" alt="Paganini Logo" width="120" style="border-radius: 20px" onerror="this.style.display='none'"/>
  
  # Paganini
  
  **Multi-Modal AI Video Intelligence Platform**
